...
from zonos2.vendor.nemo_text_processing.text_normalization.data_loader_utils import (
    load_file,
    post_process_punct,
    pre_process,
    write_file,
)
from zonos2.vendor.nemo_text_processing.text_normalization.preprocessing_utils import additional_split
from zonos2.vendor.nemo_text_processing.text_normalization.token_parser import PRESERVE_ORDER_KEY, TokenParser
from zonos2.vendor.nemo_text_processing.utils.logging import logger
...
To integrate Normalizer in your script:
    >>> from zonos2.vendor.nemo_text_processing.text_normalization.normalize import Normalizer
...
class Normalizer:
    ...
    def __init__(
        ...
        if lang == "en":
            from zonos2.vendor.nemo_text_processing.text_normalization.en.verbalizers.post_processing import PostProcessingFst
            from zonos2.vendor.nemo_text_processing.text_normalization.en.verbalizers.verbalize_final import VerbalizeFinalFst

            if post_process:
                self.post_processor = PostProcessingFst(cache_dir=cache_dir, overwrite_cache=overwrite_cache)

            if deterministic:
                from zonos2.vendor.nemo_text_processing.text_normalization.en.taggers.tokenize_and_classify import ClassifyFst
            else:
                if lm:
                    from zonos2.vendor.nemo_text_processing.text_normalization.en.taggers.tokenize_and_classify_lm import ClassifyFst
                else:
                    from zonos2.vendor.nemo_text_processing.text_normalization.en.taggers.tokenize_and_classify_with_audio import (
                        ClassifyFst,
                    )
        elif lang == 'ru':
            # Ru TN only support non-deterministic cases and produces multiple normalization options
            # use normalize_with_audio.py
            from zonos2.vendor.nemo_text_processing.text_normalization.ru.taggers.tokenize_and_classify import ClassifyFst
            from zonos2.vendor.nemo_text_processing.text_normalization.ru.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'de':
            from zonos2.vendor.nemo_text_processing.text_normalization.de.taggers.tokenize_and_classify import ClassifyFst
            from zonos2.vendor.nemo_text_processing.text_normalization.de.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'es':
            from zonos2.vendor.nemo_text_processing.text_normalization.es.taggers.tokenize_and_classify import ClassifyFst
            from zonos2.vendor.nemo_text_processing.text_normalization.es.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'fr':
            from zonos2.vendor.nemo_text_processing.text_normalization.fr.taggers.tokenize_and_classify import ClassifyFst
            from zonos2.vendor.nemo_text_processing.text_normalization.fr.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'sv':
            from zonos2.vendor.nemo_text_processing.text_normalization.sv.taggers.tokenize_and_classify import ClassifyFst
            from zonos2.vendor.nemo_text_processing.text_normalization.sv.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'hu':
            from zonos2.vendor.nemo_text_processing.text_normalization.hu.taggers.tokenize_and_classify import ClassifyFst
            from zonos2.vendor.nemo_text_processing.text_normalization.hu.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'zh':
            from zonos2.vendor.nemo_text_processing.text_normalization.zh.taggers.tokenize_and_classify import ClassifyFst
            from zonos2.vendor.nemo_text_processing.text_normalization.zh.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'ar':
            from zonos2.vendor.nemo_text_processing.text_normalization.ar.taggers.tokenize_and_classify import ClassifyFst
            from zonos2.vendor.nemo_text_processing.text_normalization.ar.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'hi':
            from zonos2.vendor.nemo_text_processing.text_normalization.hi.taggers.tokenize_and_classify import ClassifyFst
            from zonos2.vendor.nemo_text_processing.text_normalization.hi.verbalizers.post_processing import PostProcessingFst
            from zonos2.vendor.nemo_text_processing.text_normalization.hi.verbalizers.verbalize_final import VerbalizeFinalFst

            if post_process:
                self.post_processor = PostProcessingFst(cache_dir=cache_dir, overwrite_cache=overwrite_cache)
        elif lang == 'it':
            from zonos2.vendor.nemo_text_processing.text_normalization.it.taggers.tokenize_and_classify import ClassifyFst
            from zonos2.vendor.nemo_text_processing.text_normalization.it.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'hy':
            from zonos2.vendor.nemo_text_processing.text_normalization.hy.taggers.tokenize_and_classify import ClassifyFst
            from zonos2.vendor.nemo_text_processing.text_normalization.hy.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'rw':
            from zonos2.vendor.nemo_text_processing.text_normalization.rw.taggers.tokenize_and_classify import ClassifyFst
            from zonos2.vendor.nemo_text_processing.text_normalization.rw.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'ja':
            from zonos2.vendor.nemo_text_processing.text_normalization.ja.taggers.tokenize_and_classify import ClassifyFst
            from zonos2.vendor.nemo_text_processing.text_normalization.ja.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'vi':
            from zonos2.vendor.nemo_text_processing.text_normalization.vi.taggers.tokenize_and_classify import ClassifyFst
            from zonos2.vendor.nemo_text_processing.text_normalization.vi.verbalizers.post_processing import PostProcessingFst
            from zonos2.vendor.nemo_text_processing.text_normalization.vi.verbalizers.verbalize_final import VerbalizeFinalFst

            if post_process:
                self.post_processor = PostProcessingFst(cache_dir=cache_dir, overwrite_cache=overwrite_cache)
        elif lang == 'pt':
            from zonos2.vendor.nemo_text_processing.text_normalization.pt.taggers.tokenize_and_classify import ClassifyFst
            from zonos2.vendor.nemo_text_processing.text_normalization.pt.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'ko':
            from zonos2.vendor.nemo_text_processing.text_normalization.ko.taggers.tokenize_and_classify import ClassifyFst
            from zonos2.vendor.nemo_text_processing.text_normalization.ko.verbalizers.verbalize_final import VerbalizeFinalFst
        else:
